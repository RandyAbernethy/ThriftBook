...
service TradeHistory {
     ...
     *
     * @param fishes the symbols for the fishes to return trades for
     ...
     */
    list<Trade> GetLastSaleList(1: set<string> fishes
